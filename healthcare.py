...
def pivot_IHME(df):
    ...
    pivoted_df.to_csv('/home/gdiaz21/Global_Healthcare/datasets/pivotted_dataframe_IHME.csv', index=False)
...
def pivot_WHO(df):
    ...
    pivoted_df.to_csv('/home/gdiaz21/Global_Healthcare/datasets/pivotted_dataframe_WHO.csv', index=False)
...
def main():
    ...
    file_path = "/home/gdiaz21/Global_Healthcare/datasets/"
